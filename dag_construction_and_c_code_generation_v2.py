...
# Generate C code from topological order [Version 1]
def generate_c_code_v1(graph):
...
# Generate C code from topological order [Version 2]
def generate_c_code_v2(graph):
    topo_order = topological_sort(graph)  # Get nodes in dependency order
    c_code = [
...
if __name__ == "__main__":
    ...
    try:
        ...
        c_code = generate_c_code_v1(dag)
        #c_code = generate_c_code_v2(dag)
        print(c_code)
