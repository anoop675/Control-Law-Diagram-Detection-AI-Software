...
def detect_lines(image_path, theta_values):
    ...
    blurred = cv2.bilateralFilter(img,6,50,50)
...
if __name__ == "__main__":
  ...
  for cluster in clusters:
      normalized_lines.append(group_and_merge(cluster, threshold=5)) #first-pass of merging lines

  flat_list = [line for cluster in normalized_lines for line in cluster]
  lines = merge_lines2(flat_list) #second-pass of merging lines
  '''
  # Draw detected lines
  i = 1
